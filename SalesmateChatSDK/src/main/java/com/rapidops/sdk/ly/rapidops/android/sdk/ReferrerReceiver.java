 ...
 * ADB Testing
 * adb shell
 * am broadcast -a com.android.vending.INSTALL_REFERRER --es "referrer" "Rapidops Analytics_cid%3Dcb14e5f33b528334715f1809e4572842c74686df%26RapidopsAnalytics_cuid%3Decf125107e4e27e6bcaacb3ae10ddba66459e6ae"
**/
//******************************************************************************
        ...
        try
        {
            ...
            if ((null != intent) && (intent.getAction().equals("com.android.vending.INSTALL_REFERRER")))
            {
                ...
                if (null != rawReferrer)
                {
                    ...
                    Log.d(Rapidops.TAG, "Referrer: " + referrer);
                    ...
                    Log.d(Rapidops.TAG, "Processed: " + res);
