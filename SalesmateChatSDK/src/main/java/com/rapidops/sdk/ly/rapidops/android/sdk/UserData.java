...
public class UserData {
    ...
    public static void setData(Map<String, String> data){
        ...
        if(picturePath != null){
            ...
            if (!sourceFile.isFile()) {
                if (Rapidops.sharedInstance().isLoggingEnabled()) {
                    Log.w(Rapidops.TAG, "Provided file " + picturePath + " can not be opened");
                }
                picturePath = null;
            }
        }
        ...
        if(data.containsKey(BYEAR_KEY)){
            try {
                ...
                if (Rapidops.sharedInstance().isLoggingEnabled()) {
                    Log.w(Rapidops.TAG, "Incorrect byear number format");
                }
                byear = 0;
            }
        }
    ...
    protected static JSONObject toJSON() {
        ...
        try {
            ...
            if (Rapidops.sharedInstance().isLoggingEnabled()) {
                Log.w(Rapidops.TAG, "Got exception converting an UserData to JSON", e);
            }
        }
        ...
        if(json != null){
            ...
            if (!json.isNull(CUSTOM_KEY)) {
                ...
                try {
                    ...
                    if (Rapidops.sharedInstance().isLoggingEnabled()) {
                        Log.w(Rapidops.TAG, "Got exception converting an Custom Json to Custom User data", e);
                    }
                }
            }
        }
