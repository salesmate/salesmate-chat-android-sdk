...
class DeviceInfo {
    ...
    static String getResolution(final Context context) {
        ...
        try {
            ...
            if (Rapidops.sharedInstance().isLoggingEnabled()) {
                Log.i(Rapidops.TAG, "Device resolution cannot be determined");
            }
        }
        return resolution;
    }
    ...
    static String getCarrier(final Context context) {
        ...
        if (carrier == null || carrier.length() == 0) {
            carrier = "";
            if (Rapidops.sharedInstance().isLoggingEnabled()) {
                Log.i(Rapidops.TAG, "No carrier found");
            }
        }
        return carrier;
    }
    ...
    static String getAppVersion(final Context context) {
        String result = Rapidops.DEFAULT_APP_VERSION;
        try {
            result = context.getPackageManager().getPackageInfo(context.getPackageName(), 0).versionName;
        }
        catch (PackageManager.NameNotFoundException e) {
            if (Rapidops.sharedInstance().isLoggingEnabled()) {
                Log.i(Rapidops.TAG, "No app version found");
            }
        }
        return result;
    }
    ...
    static String getStore(final Context context) {
        ...
        try {
            ...
            if (Rapidops.sharedInstance().isLoggingEnabled()) {
                Log.i(Rapidops.TAG, "Can't get Installer package [getStore]");
            }
        }
        if (result == null || result.length() == 0) {
            result = "";
            if (Rapidops.sharedInstance().isLoggingEnabled()) {
                Log.i(Rapidops.TAG, "No store found [getStore]");
            }
        }
        return result;
    }
